...
* panic (`zerolog.PanicLevel`, 6)
* fatal (`zerolog.FatalLevel`, 5)
* error (`zerolog.ErrorLevel`, 4)
* warn (`zerolog.WarnLevel`, 3)
* info (`zerolog.InfoLevel`, 2)
* debug (`zerolog.DebugLevel`, 1)
* trace (`zerolog.TraceLevel`, 0)
