...
const (
	...
	InfoLevel
	// NoticeLevel defines notice log level.
	NoticeLevel
...
func ParseLevel(levelStr string) (Level, error) {
	...
	case strings.EqualFold(levelStr, LevelFieldMarshalFunc(NoticeLevel)):
...
// Notice starts a new message with info level.
//
// You must call Msg on the returned event in order to send the event.
func (l *Logger) Notice() *Event {
	return l.newEvent(NoticeLevel, nil)
}
